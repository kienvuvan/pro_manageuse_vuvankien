					...
					<div style="padding-left: 100px;" id="japan">
						<table border="1" width="70%" class="tbl_input" cellpadding="4" cellspacing="0">
							...
							<tr>
								...
								<td align="left">${fn:escapeXml(fn:replace(userInfor.startDate, '-', '/'))}</td>
							</tr>
							<tr>
								<td class="lbl_left">失効日:</td>
								<td align="left">${fn:escapeXml(fn:replace(userInfor.endDate, '-', '/'))}</td>
							</tr>
							<tr>
			...
			<table border="0" cellpadding="4" cellspacing="0" width="300px">
				<tr>
					...
					<c:if test="${userInfor.rule != 0}">
						<td>
							<a href="deleteUserConfirm.do?userId=${userInfor.userId}">
								<input class="btn" type="button" onclick="return confirm('${messageDelete}')" value="削除" />
							</a>
						</td>
					</c:if>
