							...
							<tr>
								...
								<td align="left">
									<c:choose>
									    ...
									    <c:otherwise>
									    	<label>${fn:escapeXml(userInfor.loginName)}</label>
									    	<input type="hidden" name="loginName" value="${fn:escapeXml(userInfor.loginName)}">
									    </c:otherwise>
									</c:choose>
								</td>
							</tr>
					...
					<div style="padding-left: 100px;" id="japan">
						<table border="0" width="100%" class="tbl_input" cellpadding="4" cellspacing="0">
							...
							<tr>
								...
								<td align="left"><input class="txBox" type="text"
									name="totalScore"
									value="${fn:escapeXml(userInfor.totalScore)}"
